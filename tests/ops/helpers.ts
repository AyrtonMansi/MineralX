...
export async function setup(extra=true){
 ...
 for(const name of ['202609060001_gic.sql','202609060002_run_timing.sql','20260907010000_operations_core.sql','20260907011000_operations_gold.sql',...(extra?['20260907012000_operations_geology.sql','20260907013000_operations_reads.sql']:[])]) {
