...
export default defineConfig({
  testDir:'./e2e',testMatch:['release-workflows.spec.js','spatial-workflows.spec.js','ops-reconciliation.spec.js','ops-login.spec.js','ops-development.spec.js','workflow-upgrade.spec.js','workflow-map-selection.spec.js','pit-workspace.spec.js','meetings-workspace.spec.js'],fullyParallel:false,workers:1,retries:0,timeout:45000,
