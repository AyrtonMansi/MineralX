...
export default defineConfig({
  testDir:'./e2e',testMatch:['release-workflows.spec.js','spatial-workflows.spec.js','ops-reconciliation.spec.js','ops-login.spec.js','ops-development.spec.js'],fullyParallel:false,workers:1,retries:0,timeout:45000,
