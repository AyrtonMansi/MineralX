...
export default function Login(){
 ...
 const [mode,setMode]=useState<'signin'|'reset'>('signin'),[busy,setBusy]=useState(false),[error,setError]=useState(''),[message,setMessage]=useState(''),[hydrated,setHydrated]=useState(false);
 ...
 <button className="ops-primary" disabled={busy||!interactive}>{busy?'Please wait…':mode==='signin'?'Sign in':'Send reset link'}</button>
 </form>
