...
export default function Home() {
  ...
  return <>
    <Heading title={scopeLabel(scope, development)} description="Plan the work here. Continue it in the field, processing or gold register — without entering it twice." action={scope.permissions.includes('work.write') && tasks.length > 0 && <button className="ops-primary" disabled={!data} onClick={createTask}>Create task</button>} />
